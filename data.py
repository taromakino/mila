...
def save_cifar10(train_ratio=0.8):
    '''
    Since CIFAR-10 doesn't come with a validation set, we create one here and save the files to disk.
    '''
...
def get_cifar10(config):
    ...
    x_train, y_train, x_val, y_val, x_test, y_test = x_train[:200], y_train[:200], x_val[:200], y_val[:200], x_test[:200], y_test[:200]
    # Train
